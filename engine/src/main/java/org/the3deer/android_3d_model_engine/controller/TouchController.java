...
public class TouchController implements EventListener {
	...
	public boolean onMotionEvent(MotionEvent motionEvent) {
		...
		if (pointerCount == 1) {
			...
			Log.d(TAG, "!@# onMotionEvent: vector[0]:"+vector[0]);
			Log.d(TAG, "!@# onMotionEvent: vector[1]:"+vector[1]);
			Log.d(TAG, "!@# onMotionEvent: vector[2]:"+vector[2]);
			Log.d(TAG, "!@# onMotionEvent: vector[2]:"+vector[2]);
			Log.d(TAG, "!@# onMotionEvent: vector[3]:"+vector[3]);
